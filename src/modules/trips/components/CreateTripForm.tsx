...
import { Loader2, User, Car, MapPin, Calendar, Clock, Clipboard } from 'lucide-react';
            ...
            <div className="p-8 space-y-8">
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-6">
                        <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider">Trip Details</h3>
                    ...
                    <div className="flex items-center justify-end gap-4 pt-6 mt-8 border-t border-slate-100">
                        ...
                        >
                            {loading ? (
                                ...
                                tripId ? 'Update Trip Record' : 'Create Official Trip'
                            )}
                        </Button>
                    </div>
                </form>
