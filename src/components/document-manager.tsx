...
export function DocumentManager({ ownerId, purpose, source, onUploadSuccess }: DocumentManagerProps) {
    ...
    const uploadMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['documents', ownerId, purpose] })
            onUploadSuccess?.()
        },
        onError: (error: any) => {
