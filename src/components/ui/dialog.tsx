    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
          "duration-150",
          // Mobile: full width with margins, positioned lower on screen
          "inset-x-4 top-[5%] max-h-[90dvh] translate-x-0 translate-y-0",
          // Tablet and up: centered positioning with max-width
          "sm:inset-auto sm:top-[50%] sm:left-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-h-[85vh] sm:w-full",
          // Padding adjustments
          "p-4 sm:p-6",
          className
        )}
